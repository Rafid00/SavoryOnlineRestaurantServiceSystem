...
<body class="bg-[#E8C07D] overflow-x-hidden">
    ...
    <div class="scroll-container h-screen w-screen flex flex-col">
        <section class="scroll-child contact-us h-[100%] lg:h-screen bg-[#282421] w-screen relative z-20">
            <div class="grid lg:grid-cols-2 grid-cols-1 overflow-hidden h-full">
                <div class="about-us-home-pic h-full lg:h-screen absolute lg:relative -z-50">
                    <div
                        class="main-filter h-full lg:h-screen bg-black opacity-60 lg:opacity-20 w-screen lg:w-[50vw] absolute top-0 left-0 -z-40 lg:z-50">
                    </div>
                    <img class="w-screen h-full lg:w-[50vw] relative -z-50 lg:block lg:h-screen object-cover"
                        src="images/contact-us-img.jpg" alt="" />
                </div>
                <div class="flex justify-center items-center flex-col h-full lg:h-[90%]">
                    <div
                        class="title text-white text-3xl md:text-5xl lg:text-7xl z-50 text-center border-2 w-fit lg:mt-20 mb-6">
                        Contact Us</div>
                    <div class="text-gray-200 text-xs md:text-base lg:text-xl mb-2 font-medium uppercase">let us know
                        your thoughts</div>
        ...
        <section class="scroll-child h-[120%] lg:h-screen bg-[#282421] w-screen relative" id="ourMission">
            <div class="grid grid-cols-1 lg:grid-cols-2 overflow-hidden h-full lg:h-screen">
                <div class="flex justify-center items-center flex-col h-full lg:h-[90%]">
                    <div class="title text-white text-3xl md:text-5xl lg:text-7xl z-50 text-center border-2 w-fit mt-10 lg:mt-20 mb-6">Outlets</div>
                    <div class="text-gray-200 text-xs md:text-base lg:text-xl mb-2 font-medium uppercase">Location We Have Reached</div>
                    <div class="h-[2px] w-[180px] bg-white my-1 rounded"></div>
                    <div class="h-[2px] w-[180px] bg-white my-1 rounded mb-10"></div>

                    <div class="text-justify text-white mb-10 lg:mb-5 translate-x-4 lg:translate-x-7 text-xs md:text-sm lg:text-base">
                ...
                <div class="map h-screen relative overflow-hidden transition-all duration-200">
                    <iframe class="h-screen w-screen lg:w-[50vw]"
    ...
    <script>
        ...
        document.getElementsByClassName("bashundhara")[0].addEventListener("click", () => {
            ...
            class="h-screen w-screen lg:w-[50vw]"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d58398.27067050475!2d90.33915681322443!3d23.82244214738285!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c64d69573381%3A0x1b6904c6ebc86957!2sKhana&#39;s%20-%20Bashundhara%20R%2FA!5e0!3m2!1sen!2sbd!4v1667408054052!5m2!1sen!2sbd"
            width="600"
            height="450"
            style="border: 0"
        ...
        document.getElementsByClassName("graam")[0].addEventListener("click", () => {
            document.getElementsByClassName(
                ...
                `<iframe class="h-screen w-screen lg:w-[50vw]" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3648.3064462136704!2d90.38640822936988!3d23.878749740298282!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c509e0ac30d3%3A0xecc6f998db0a14f7!2sKhana&#39;s%20Uttara%20Classic!5e0!3m2!1sen!2sbd!4v1667410289171!5m2!1sen!2sbd" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>`;
        });
        document.getElementsByClassName("mohammadpur")[0].addEventListener("click", () => {
            document.getElementsByClassName(
                "map"
            )[0].innerHTML =
                `<iframe class="h-screen w-screen lg:w-[50vw]" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.581524070731!2d90.35901631538488!3d23.76229789423764!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755bfc41eac59d1%3A0x2136aa891096f5f!2zS2hhbmEncyBNb2hhbW1hZHB1ciAtIOCmluCmvuCmqOCmvuCmuCDgpq7gp4vgprngpr7gpq7gp43gpq7gpqbgpqrgp4HgprA!5e0!3m2!1sen!2sbd!4v1667410334038!5m2!1sen!2sbd" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>`;
        });
    </script>
</body>
